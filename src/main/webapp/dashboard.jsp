...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active">
            <a href="dashboard.jsp"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a>
        </li>
            ...
            <div class="panel panel-default">
                <div class="panel-body easypiechart-panel">
                    ...
                    <div class="easypiechart" id="easypiechart-blue" data-percent="100">
                        <span class="percent" id="todayExpense">0</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body easypiechart-panel">
                    ...
                    <div class="easypiechart" id="easypiechart-orange" data-percent="100">
                        <span class="percent" id="yesterdayExpense">0</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body easypiechart-panel">
                    ...
                    <div class="easypiechart" id="easypiechart-teal" data-percent="100">
                        <span class="percent" id="weekExpense">0</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body easypiechart-panel">
                    ...
                    <div class="easypiechart" id="easypiechart-red" data-percent="100">
                        <span class="percent" id="monthExpense">0</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-6 col-md-3">
            <div class="panel panel-default">
                <div class="panel-body easypiechart-panel">
                    ...
                    <div class="easypiechart" id="easypiechart-red" data-percent="100">
                        <span class="percent" id="yearExpense">0</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-6 col-md-3">
            <div class="panel panel-default">
                <div class="panel-body easypiechart-panel">
                    ...
                    <div class="easypiechart" id="easypiechart-red" data-percent="100">
                        <span class="percent" id="totalExpense">0</span>
                    </div>
                </div>
            </div>
        </div>
...
async function loadExpenses() {
    try {
        const res = await fetch('<%=request.getContextPath()%>/api/expenses/summary');
        const data = await res.json();

        document.getElementById('todayExpense').textContent = data.today;
        document.getElementById('yesterdayExpense').textContent = data.yesterday;
        document.getElementById('weekExpense').textContent = data.week;
        document.getElementById('monthExpense').textContent = data.month;
        document.getElementById('yearExpense').textContent = data.year;
        document.getElementById('totalExpense').textContent = data.total;
    } catch (err) {
        console.error(err);
    }
}
