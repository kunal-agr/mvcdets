...
<html>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="parent">
                <a data-toggle="collapse" href="#sub-item-1"><em class="fa fa-navicon">&nbsp;</em>Expenses<span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span></a>
            ...
            <li class="parent">
                <a data-toggle="collapse" href="#sub-item-2"><em class="fa fa-navicon">&nbsp;</em>Expense Report<span data-toggle="collapse" href="#sub-item-2" class="icon pull-right"><em class="fa fa-plus"></em></span></a>
    ...
    <script>
        document.getElementById("datewiseForm").addEventListener("submit", function(e){
            e.preventDefault();
            const fromDate = this.fromdate.value;
            const toDate = this.todate.value;

            fetch('<%=request.getContextPath()%>/api/expenses/date?fromdate=' + fromDate + '&todate=' + toDate)
                .then(res => {
                    if (!res.ok) throw new Error('Network response was not ok');
                    return res.json();
                })
                .then(data => {
                    // Save data in sessionStorage and redirect to result page
                    sessionStorage.setItem("datewiseResult", JSON.stringify(data));
                    window.location.href = 'expense-datewise-result.jsp';
                })
