...
<%
    ...
    if (request.getAttribute("user") == null) {
      request.getRequestDispatcher("user?action=profile")
        ...
        <ul class="nav menu">
            ...
            <li class="parent"><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    <li><a class="" href="add-expense.jsp"><span class="fa fa-arrow-right">&nbsp;</span> Add Expenses</a></li>
                    <li><a class="" href="manage-expense.jsp"><span class="fa fa-arrow-right">&nbsp;</span> Manage Expenses</a></li>
                </ul>
            </li>
            ...
            <li class="parent"><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse" id="sub-item-2">
                    <li><a class="" href="expense-datewise-reports.jsp"><span class="fa fa-arrow-right">&nbsp;</span> Daywise Expenses</a></li>
                    <li><a class="" href="expense-monthwise-reports.jsp"><span class="fa fa-arrow-right">&nbsp;</span> Monthwise Expenses</a></li>
                    <li><a class="" href="expense-yearwise-reports.jsp"><span class="fa fa-arrow-right">&nbsp;</span> Yearwise Expenses</a></li>
                </ul>
            </li>
